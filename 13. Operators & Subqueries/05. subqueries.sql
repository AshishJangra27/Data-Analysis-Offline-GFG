...
select city, count(*) as 'restaurants' from restaurants 
where city not in (select city  from restaurants group by city order by avg(rating_count) desc limit 5)
group by city 

order by restaurants desc limit 5;
